...
export const CONDITION_PATHWAYS: ConditionPathway[] = [
  {
    ...
    stages: [
      ...
      },
      {
        ...
        name: 'Controlled',
        type: 'control',
        indicatorCodes: ['CVDP002HYP', 'CVDP003HYP', 'CVDP007HYP', 'CVDP010HYP'],
        description: 'Treated to appropriate BP threshold',
        higherIsBetter: true,
      },
      {
        id: 'treatment-safety',
        name: 'Potential Overtreatment',
        type: 'treatment',
        indicatorCodes: ['CVDP006HYP'],
        description: 'Potential antihypertensive overtreatment',
  ...
  },
  {
    ...
    stages: [
      ...
      },
      {
        ...
        name: 'Treated',
        type: 'treatment',
        indicatorCodes: ['CVDP005CKD', 'CVDP008CKD'],
        description: 'RAS antagonist and SGLT2 inhibitor treatment',
        higherIsBetter: true,
      },
      {
        id: 'control',
  ...
  },
  {
    ...
    name: 'Heart Failure',
    shortName: 'HF',
    description: 'Heart failure diagnosis, monitoring and treatment',
    ...
    stages: [
      {
        ...
        name: 'Diagnosed',
        type: 'prevalence',
        indicatorCodes: ['CVDP001HF'],
        description: 'Recorded heart failure prevalence',
        higherIsBetter: true,
      },
      {
        id: 'monitoring',
        name: 'Monitored',
        type: 'monitoring',
        indicatorCodes: ['CVDP002HF'],
        description: 'Monitoring with eGFR',
        higherIsBetter: true,
      },
      {
        id: 'treatment',
        name: 'Treated',
        type: 'treatment',
        indicatorCodes: ['CVDP003HF', 'CVDP004HF'],
        description: 'Four pillar model and SGLT2 inhibitor treatment',
        higherIsBetter: true,
      },
    ],
    outcomeIndicatorCodes: ['CVDP001MORT', 'CVDP002MORT'],
  },
  {
    ...
    name: 'Diabetes',
    shortName: 'DM',
    description: 'Diabetes detection and SGLT2 inhibitor treatment',
    ...
    stages: [
      {
        ...
        name: 'Detection Gaps',
        type: 'detection',
        indicatorCodes: ['CVDP002NDH', 'CVDP003DM', 'CVDP005DM'],
        description: 'Raised HbA1c without a recorded diagnosis',
        higherIsBetter: false,
      },
      {
        id: 'treatment',
        name: 'Treated',
        type: 'treatment',
        indicatorCodes: ['CVDP006DM'],
        description: 'Type 2 diabetes treated with an SGLT2 inhibitor',
        higherIsBetter: true,
      },
    ],
  ...
  {
    id: 'CVKM',
    name: 'Cardiovascular–Kidney–Metabolic',
    shortName: 'CVKM',
    description: 'Treatment across cardiovascular, kidney and metabolic disease',
    color: NHS_COLORS.darkBlue,
    stages: [
      {
        id: 'treatment',
        name: 'SGLT2i Treatment',
        type: 'treatment',
        indicatorCodes: ['CVDP001CVKM'],
        description: 'CKD, heart failure or type 2 diabetes treated with an SGLT2 inhibitor',
        higherIsBetter: true,
      },
      {
        id: 'control',
        name: 'Risk Factors Controlled',
        type: 'control',
        indicatorCodes: ['CVDP002CVKM'],
        description: 'CVD with blood pressure and cholesterol treated to threshold',
        higherIsBetter: true,
      },
    ],
    outcomeIndicatorCodes: ['CVDP001MORT', 'CVDP002MORT'],
